    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='указать сумму', verbose_name='Сборы в США')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режисеры')),
